...
const REZEPTE=[
 ...
 {id:'f2',typ:'f',name:'Rührei mit Tomaten und Basilikum',zutaten:[Z('Eier',E),Z('Tomaten',G),Z('Basilikum',OE),Z('Olivenöl',OE),Z('Sauerteigbrot',K)]},
 {id:'f3',typ:'f',name:'Haferbrot mit Butter, laktosefreiem Topfen und Schnittlauch',zutaten:[Z('Haferbrot / Buchweizenbrot',K),Z('Butter',M),Z('Laktosefreier Topfen',M),Z('Schnittlauch',G)]},
 ...
 {id:'f5',typ:'f',name:'Spanisches Omelette mit Kürbis und Kartoffelwürfeln',zutaten:[Z('Eier',E),Z('Kürbis',G),Z('Kartoffeln',G),Z('Olivenöl',OE),Z('Paprika',G)]},
 ...
 {id:'m7',typ:'m',name:'Quinoa-Bowl mit Tofu, Gurke, Paprika und Sesam',zutaten:[Z('Quinoa',K),Z('Tofu (fest)',E),Z('Gurke',G),Z('Paprika',G),Z('Sesam',N),Z('Limette',O),Z('Ingwer',G)]},
 {id:'m8',typ:'m',name:'Potato Wedges mit Hühnerkeulen und Salat',fleisch:true,zutaten:[Z('Hühnerkeulen',E),Z('Kartoffeln',G),Z('Blattsalat',G),Z('Gurke',G),Z('Olivenöl',OE),Z('Paprikapulver',OE)]},
 ...
 {id:'m10',typ:'m',name:'Kohlrabicremesuppe mit Sauerteigbrot',zutaten:[Z('Kohlrabi',G),Z('Kartoffeln',G),Z('Laktosefreie Milch oder Mandelmilch',M),Z('Schnittlauch',G),Z('Sauerteigbrot',K)]},
 ...
 {id:'a4',typ:'a',name:'Camembert aus dem Rohr mit Trauben und Sauerteigbrot',zutaten:[Z('Camembert',M),Z('Trauben',O),Z('Sauerteigbrot',K),Z('Blattsalat',G)]},
 ...
 {id:'a8',typ:'a',name:'Tomaten-Gurken-Salat mit Cottage Cheese und Sauerteigbrot',zutaten:[Z('Tomaten',G),Z('Gurke',G),Z('Cottage Cheese laktosefrei',M),Z('Sauerteigbrot',K),Z('Olivenöl',OE),Z('Schnittlauch',G)]},
 ...
 {id:'a10',typ:'a',name:'Reis-Gemüse-Pfanne mit Ei',zutaten:[Z('Reis',K),Z('Karotten',G),Z('Paprika',G),Z('Zucchini',G),Z('Eier',E),Z('Ingwer',G),Z('Rapsöl',OE)]}
];
...
const TIPPS=[
 {titel:'Grundtricks FODMAP-arm kochen',punkte:[
  ...
  'Brot: Sauerteig (lang geführt) statt Semmel oder Toast. Sonst Hafer-, Buchweizen- oder Reisbrot.',
